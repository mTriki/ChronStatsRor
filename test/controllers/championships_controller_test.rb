...
class ChampionshipsControllerTest < ActionController::TestCase
  ...
  test "should create championship" do
    assert_difference('Championship.count') do
      post :create, championship: { federation_id: @championship.federation_id, name: @championship.name, season_id: @championship.season_id }
    end
  ...
  test "should update championship" do
    patch :update, id: @championship, championship: { federation_id: @championship.federation_id, name: @championship.name, season_id: @championship.season_id }
    assert_redirected_to championship_path(assigns(:championship))
  end
