...
class GymsControllerTest < ActionController::TestCase
  ...
  test "should create gym" do
    assert_difference('Gym.count') do
      post :create, gym: { adress: @gym.adress, city: @gym.city, federation_id: @gym.federation_id, name: @gym.name, zip: @gym.zip }
    end
  ...
  test "should update gym" do
    patch :update, id: @gym, gym: { adress: @gym.adress, city: @gym.city, federation_id: @gym.federation_id, name: @gym.name, zip: @gym.zip }
    assert_redirected_to gym_path(assigns(:gym))
  end
